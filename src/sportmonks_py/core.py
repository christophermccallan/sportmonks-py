...
class CoreClient(BaseClient):
    ...
    def get_all_cities(self, async_mode: bool = False) -> StdResponse | AsyncResponse:
        """
    ...
    def get_all_regions(self, async_mode: bool = False) -> StdResponse | AsyncResponse:
        """
        This endpoint returns all available filters for the entities.
    ...
    def get_all_types(self, async_mode: bool = False) -> StdResponse | AsyncResponse:
        """
        This endpoint returns all available filters  for the entities.
        :param async_mode: Whether to use async mode.
        :return: Dictionary of filters.
